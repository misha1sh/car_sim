...
//    VERIFY(ingoing_segment.segment_group_id != outgoing_segment.segment_group_id);
//
//    PointF median_dir = outgoing_segment.dir.RightPerpendicular();
//
//    const auto ingoing_perp = ingoing_segment.dir.RightPerpendicular();
//    const auto outgoing_perp = outgoing_segment.dir.RightPerpendicular();
//
...
//                const PointF pm_j = ingoing_segment.p2 + median_dir * lane_width_ * j;
...
//    VERIFY(ingoing_segment.segment_group_id != outgoing_segment.segment_group_id);
//
//    PointF median_dir = ingoing_segment.dir.RightPerpendicular();
//
//    const auto ingoing_perp = ingoing_segment.dir.RightPerpendicular();
//    const auto outgoing_perp = outgoing_segment.dir.RightPerpendicular();
//
...
CreateLane(left_medium, right_medium, left_top, right_top);
         ...
         const PointF left_medium = medium - (medium - ingoing_segment.p2).Norm() * lane_width_;
        const PointF right_medium = medium;
